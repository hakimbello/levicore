...
25. `code.cmd --new-window --user-data-dir "$env:TEMP\levicore-rc006a-user-data" --extensions-dir "$env:TEMP\levicore-rc006a-extensions" --extensionDevelopmentPath=packages/vscode-extension "<WORKSPACE>"`
...
31. `code.cmd --new-window --user-data-dir "$env:TEMP\levicore-rc006a-user-data-absolute" --extensions-dir "$env:TEMP\levicore-rc006a-extensions-absolute" --extensionDevelopmentPath="<WORKSPACE>\packages\vscode-extension" "<WORKSPACE>"`
...
36. `code.cmd --new-window --user-data-dir "$env:TEMP\levicore-rc006a-user-data-absolute" --extensions-dir "$env:TEMP\levicore-rc006a-extensions-absolute" --extensionDevelopmentPath="<WORKSPACE>\packages\vscode-extension" "<WORKSPACE>"`
...
40. `Select-String -Path $env:TEMP\levicore-rc006a-user-data-absolute\logs\20260718T213251\**\* -Pattern 'api[_-]?key|token|secret|password|BEGIN|PRIVATE KEY|prompt|source code|<WORKSPACE>\\src' -CaseSensitive:$false -ErrorAction SilentlyContinue`
...
```powershell
code.cmd --new-window --user-data-dir "$env:TEMP\levicore-rc006a-user-data" --extensions-dir "$env:TEMP\levicore-rc006a-extensions" --extensionDevelopmentPath=packages/vscode-extension "<WORKSPACE>"
```
...
```text
2026-07-18 21:30:03.672 [info] Loading development extension at <WORKSPACE>\packages\vscode-extension
...
- Reproduction steps:
  1. From the repository root, run the documented relative launch path through VS Code CLI: `code.cmd --new-window --user-data-dir "$env:TEMP\levicore-rc006a-user-data" --extensions-dir "$env:TEMP\levicore-rc006a-extensions" --extensionDevelopmentPath=packages/vscode-extension "<WORKSPACE>"`.
...
code.cmd --new-window --user-data-dir "$env:TEMP\levicore-rc006a-repair-user-data" --extensions-dir "$env:TEMP\levicore-rc006a-repair-extensions" "<WORKSPACE>"
```
...
```text
2026-07-18 21:47:11.873 [info] Loading development extension at <WORKSPACE>\packages\vscode-extension
```
...
```text
2026-07-18 21:49:53.471 [info] Loading development extension at <WORKSPACE>\packages\vscode-extension
```
