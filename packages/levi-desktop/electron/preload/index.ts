...
const leviApi: LeviApiWithWorkspaceTree = {
  ...
  projects: {
    ...
    mobileEnvironment: () => ipcRenderer.invoke(IPC_CHANNELS.projectsMobileEnvironment),
  ...
  agent: {
    ...
    restoreOperation: (request: AgentRestoreOperationRequest) => ipcRenderer.invoke(IPC_CHANNELS.agentRestoreOperation, request),
    resumeOperation: (request: AgentResumeOperationRequest) => ipcRenderer.invoke(IPC_CHANNELS.agentResumeOperation, request),
