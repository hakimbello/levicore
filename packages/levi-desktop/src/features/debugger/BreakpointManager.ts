...
export class BreakpointManager {
  ...
  set(request: DebugSetBreakpointRequest): DebugBreakpoint {
    ...
    const breakpoint: DebugBreakpoint = {
      ...
      condition: request.condition !== undefined ? request.condition : existing?.condition,
      logMessage: request.logMessage !== undefined ? request.logMessage : existing?.logMessage,
      hitCondition: request.hitCondition !== undefined ? request.hitCondition : existing?.hitCondition,
