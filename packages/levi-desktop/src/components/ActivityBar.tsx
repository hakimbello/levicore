...
export type ActivityView = "home" | "explorer" | "search" | "debug" | "source-control" | "terminal" | "tasks" | "agent" | "runtime" | "history" | "rules" | "settings";
...
const activityItems: ActivityItem[] = [
  ...
  { view: "agent", label: "Coding Agent", icon: "chat" },
